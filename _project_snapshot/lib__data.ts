...
export const WHATSAPP_NUMBER = "923039045075";
export const WHATSAPP_DISPLAY = "0303 9045075";
...
export const WHATSAPP_MESSAGE = (productName: string, plan: string) =>
  encodeURIComponent(
    `Hey! I want to buy *${productName}* (${plan}) from ToolsTemplate. Please share the details!`
  );
...
export const reviews: Review[] = [
  ...
  { id: 3, name: "Bilal Hussain", avatar: "BH", rating: 5, comment: "Gemini Advanced is a beast for coding. The 1M context window is game-changing. ToolsTemplate made it affordable!", product: "Gemini Advanced", date: "3 days ago" },
  ...
  { id: 6, name: "Zainab Sheikh", avatar: "ZS", rating: 5, comment: "I was skeptical at first but ToolsTemplate proved me wrong. Premium quality, budget-friendly prices. 10/10!", product: "Gemini Plus", date: "4 days ago" },
];
...
export const socialLinks: SocialLink[] = [
  ...
  {
    name: "Instagram",
    url: "https://instagram.com/toolstemplate",
